...
//        TabH = vr*40/pr;
    ...
    connect(ui->doubleSpinBox_pace_rate,SIGNAL(valueChanged(double)),this,SLOT(pace_rate_handler_kn()));      // open
    connect(ui->doubleSpinBox_pace_rate_mpa,SIGNAL(valueChanged(double)),this,SLOT(pace_rate_handler_mpa())); // open
...
void PressApp::print_test_results(){
    ...
    if(tmp == 1) {
        ...
        send_data_order(data.data(),QString((QString("PRINT")+trUtf8("LINE 1 : ")+ui->lineEdit_1->text()+QString("                         "))).toLatin1().data(),0,35);
        send_data_order(data.data(),QString((QString("PRINT")+trUtf8("LINE 2 : ")+ui->lineEdit_2->text()+QString("                         "))).toLatin1().data(),0,35);
