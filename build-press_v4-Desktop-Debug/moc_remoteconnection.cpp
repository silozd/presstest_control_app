...
#include "../press_v4/remoteconnection.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RemoteConnection_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RemoteConnection_t qt_meta_stringdata_RemoteConnection = {
    {
QT_MOC_LITERAL(0, 0, 16), // "RemoteConnection"
QT_MOC_LITERAL(1, 17, 25), // "periodic_response_handler"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 4), // "data"
QT_MOC_LITERAL(4, 49, 20) // "readPendingDatagrams"

    },
    "RemoteConnection\0periodic_response_handler\0"
...
void RemoteConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RemoteConnection *_t = static_cast<RemoteConnection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->periodic_response_handler((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (RemoteConnection::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RemoteConnection::periodic_response_handler)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject RemoteConnection::staticMetaObject = {
    { &QUdpSocket::staticMetaObject, qt_meta_stringdata_RemoteConnection.data,
      qt_meta_data_RemoteConnection,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void RemoteConnection::periodic_response_handler(QByteArray _t1)
{
